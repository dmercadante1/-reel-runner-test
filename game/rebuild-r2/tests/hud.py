...
with sync_playwright()as pw:
 ...
 for width,height,mobile in [(1280,816,False),(1216,1242,False),(844,390,True),(667,375,True),(568,320,True),(390,844,True)]:
  ctx=b.new_context(viewport={'width':width,'height':height},is_mobile=mobile,has_touch=mobile,device_scale_factor=1);p=ctx.new_page();p.set_default_timeout(6000);p.on('pageerror',lambda e:errors.append(str(e)));p.set_content(H);p.wait_for_function('GOTHIC.phase==="ready"');label=f'{width}x{height}'
